...
items remain. Do not stage, commit, or push unless explicitly asked.
...
3. Use subagents when useful.
   ...
   - Good subagent tasks include fresh-context review of any step 2 angle, plus concurrency, security/privacy, performance, UI behavior, or broad reconnaissance across an unfamiliar subsystem.
...
4. Run the Bucket I clean loop.
   ...
   - Keep going while useful until no Bucket I items remain, only Bucket II decisions remain, validation/scope/context blocks safe continuation, or another pass would just be churn.
...
- Bucket I — applied safe fixes: issue, changed files, and validation evidence; or `none`
- Bucket II — needs decision: the decision needed and the main tradeoff; or `none`
- Keep As-Is — meaningful concerns inspected and intentionally rejected, when useful
