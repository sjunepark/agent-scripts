...
3. Implement the smallest coherent Release Please configuration that fits those conventions, unless the user requested only a proposal. Do not assume publishing permissions exist.
