...
const DEPRECATED_NAMES = [
  ...
  'teach-impeccable',   // folded into /impeccable-june teach
  // v2.1 merges
  'arrange',            // renamed to layout
  'normalize',          // merged into polish
  'onboard',            // merged into harden
  'extract',            // merged into /impeccable-june extract
  // v3.0 consolidation: all standalone skills -> /impeccable-june sub-commands
  'adapt',
  'animate',
  'audit',
  'bolder',
