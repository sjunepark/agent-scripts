...
description: "Delegate all frontend and UI implementation to Claude Code with a Claude-only, repository-scoped Impeccable installation while Codex scopes, orchestrates, and validates the work. Use for creating, changing, redesigning, styling, polishing, or reviewing interfaces, components, layouts, frontend behavior, design systems, responsive behavior, motion, accessibility, or UX. Do not use for work confined to backend, data, infrastructure, or other non-UI layers."
---
