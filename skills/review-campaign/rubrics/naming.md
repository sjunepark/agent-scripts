...
- **Booleans and polarity.** Check that boolean names and polarity make call sites unambiguous. Prefer positive predicates when double negation obscures behavior; preserve established public conventions.
