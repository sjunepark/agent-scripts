...
func TestExternalPlanApplyAndRestoreContracts(t *testing.T) {
	...
	if !strings.Contains(stdout, `"operation":"plan"`) || !strings.Contains(stdout, `"plan":{"desired"`) || !strings.Contains(stdout, `"action":"install"`) || !strings.Contains(stdout, `"resolved 17 desired skills"`) || strings.Contains(stdout, `"warnings":null`) {
